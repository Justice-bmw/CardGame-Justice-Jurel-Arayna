...
public class AttackCard extends ActionCard implements DealsDamage {
     ...
     * If the target has an active cancel shield, the damage is blocked.
     */
    @Override
    public void doDamage(Player currentPlayer, Player playerToDamage) {
        if (playerToDamage.consumeCancel()) {
            System.out.println(playerToDamage.getName() + " cancelled the attack!");
            return;
        }
